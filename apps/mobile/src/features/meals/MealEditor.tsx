...
import { createMeal, fetchMeal, formatLocalDate, updateMeal } from "../../lib/meals";
...
export function MealEditor({ mealId }: { mealId?: string }) {
  ...
  useEffect(() => {
    ...
    // Hydrate the editor only after the canonical meal resource exists.
  ...
  const disabled = (Boolean(mealId) && mealQuery.isPending) || mutation.isPending;
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <Stack gap="xl">
            ...
            <Stack gap="sm">
              ...
              <Text variant="title">{mealId ? copy.meal.editTitle : copy.meal.addTitle}</Text>
...
function toDraft(meal: {
  ...
  return {
    ...
    date: meal.date,
    calories: formatDraftNumber(meal.calories),
    proteinGrams: formatDraftNumber(meal.proteinGrams),
    carbohydratesGrams: formatDraftNumber(meal.carbohydratesGrams),
    fatGrams: formatDraftNumber(meal.fatGrams),
    notes: meal.notes ?? "",
  };
}
